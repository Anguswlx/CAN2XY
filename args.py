...
group.add_argument(
    ...
    type=str,
    default='pixelcnn',
    choices=['made', 'made_xy','pixelcnn', 'pixelcnn_xy','bernoulli'],
    help='network type')
...
group.add_argument('--channel', type=int, default=6, help='output channel')
group.add_argument(
    '--o2', action='store_true', help='use O_2 symmetry in sample and loss')
